    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div x-data="{ showImport: false }" class="flex flex-wrap items-center gap-3">
                <a href="{{ route('admin.students.template') }}" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 px-3 py-2 text-sm font-medium dark:border-slate-700">
                    <i class="fa-solid fa-file-excel text-xs text-green-600"></i>
                    Download Template
                </a>

                <!-- Link to dedicated import page -->
                <a href="{{ route('admin.students.import.form') }}" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 px-3 py-2 text-sm font-medium dark:border-slate-700">
                    <i class="fa-solid fa-file-upload text-xs"></i>
                    Tambah Via Excel
                </a>

                <a href="{{ route('admin.students.export') }}" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 px-3 py-2 text-sm font-medium dark:border-slate-700">
                    <i class="fa-solid fa-download text-xs"></i>
                    Export
                </a>

                <a href="{{ route('admin.students.create') }}" class="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2 text-sm font-medium text-white">
                            ...
                            <tr class="transition hover:bg-slate-50 dark:hover:bg-slate-800/60">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <a href="{{ route('admin.students.edit', $student) }}" class="rounded-lg p-1.5 text-slate-500 transition hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white">
