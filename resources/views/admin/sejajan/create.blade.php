<x-app-layout>
    ...
    <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <form action="{{ route('admin.sejajan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    @enderror
                    <p class="mt-1 text-xs text-slate-500">Hanya peserta yang belum memiliki toko</p>
                </div>
                ...
                <div>
                    ...
                    @error('photo')
                        <p class="mt-1 text-xs text-[#EF4444]">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-slate-500">Max 2MB, format: jpeg, png, jpg, gif</p>
                </div>
            </div>
