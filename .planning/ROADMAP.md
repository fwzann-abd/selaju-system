...
**Goal:** Mengaktifkan Laravel Reverb dan memastikan LMS events di-dispatch dari controller saat material actions terjadi.

**Requirements:** BCAST-01, BCAST-02, BCAST-03

**Success criteria:**
1. `php artisan reverb:start` berhasil dan WebSocket menerima koneksi
2. Event `MaterialUploaded` di-dispatch saat guru upload materi
3. `.env` config `BROADCAST_CONNECTION=reverb` (bukan `log`)
...
| 4 | Broadcasting Activation | BCAST-01..03 | — | Small |

**Recommended execution order:**
- **Wave 1** (parallel): Phase 1 + Phase 2 + Phase 4
- **Wave 2** (after Wave 1): Phase 3
