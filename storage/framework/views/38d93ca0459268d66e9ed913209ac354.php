...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="nipd" name="nipd" type="text" value="<?php echo e(old('nipd')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="nisn" name="nisn" type="text" value="<?php echo e(old('nisn')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select id="jk" name="jk" required class="mt-2 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-800 dark:border-slate-700 dark:bg-slate-800 dark:text-white">
                        ...
                        <option value="L" <?php if(old('jk') == 'L'): ?> selected <?php endif; ?>>Laki-laki</option>
                        <option value="P" <?php if(old('jk') == 'P'): ?> selected <?php endif; ?>>Perempuan</option>
                    </select>
                    <?php $__errorArgs = ['jk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
<?php endif; ?>
<?php /**PATH D:\shei\folder-v2\resources\views/admin/students/create.blade.php ENDPATH**/ ?>