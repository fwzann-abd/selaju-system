    ...
    <div class="space-y-6">
        <div class="rounded-xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900 text-center">
            ...
            <p class="text-slate-500 dark:text-slate-400">
                Halaman Data Guru sedang dalam pengembangan. Fitur ini akan segera tersedia.
            </p>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\folder-v2\resources\views/admin/lms/teachers/index.blade.php ENDPATH**/ ?>