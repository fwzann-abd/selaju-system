        ...
        <div class="mx-auto flex w-full max-w-7xl items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                <div class="hidden md:flex md:flex-col leading-tight">
                    ...
                    <span class="text-base font-semibold text-slate-900 dark:text-white"><?php echo e(Auth::user()->name); ?></span>
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div
            ...
            <div class="flex flex-col gap-1">
                <span class="font-medium text-slate-900 dark:text-white"><?php echo e(Auth::user()->name); ?></span>
                <span class="text-slate-500 dark:text-slate-400"><?php echo e(Auth::user()->email); ?></span>
            </div>
...
<?php /**PATH C:\LMSBACKEND\selaju-system\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>