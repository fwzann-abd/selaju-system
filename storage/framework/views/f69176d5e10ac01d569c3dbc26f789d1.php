...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex justify-between items-center">
            <div>
                <p class="text-sm text-slate-600 dark:text-slate-400">
                    Total Jadwal: <span
                        class="font-semibold text-slate-900 dark:text-white"><?php echo e($schedules->count()); ?></span>
                </p>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="border-b border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-slate-800">
                            <tr>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-slate-900 dark:text-white">Hari
                                </th>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-slate-900 dark:text-white">Jam
                                </th>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-slate-900 dark:text-white">Kelas
                                </th>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-slate-900 dark:text-white">Guru
                                </th>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-slate-900 dark:text-white">Mapel
                                </th>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-slate-900 dark:text-white">Ruangan
                                </th>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-slate-900 dark:text-white">Aksi
                                </th>
                            </tr>
                        </thead>
                            ...
                            <?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800 transition">
                                    <td class="px-6 py-4 text-sm text-slate-900 dark:text-slate-100">
                                        <span
                                            class="inline-block rounded-full bg-blue-100 px-3 py-1 text-xs font-semibold text-blue-800 dark:bg-blue-900 dark:text-blue-100">
                                    ...
                                    <td class="px-6 py-4 text-sm text-slate-600 dark:text-slate-300">
                                        <?php if($schedule->room): ?>
                                            <span
                                                class="inline-block rounded-full bg-purple-100 px-2 py-1 text-xs font-semibold text-purple-800 dark:bg-purple-900 dark:text-purple-100">
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        <div class="flex gap-2">
                                            <button type="button" onclick="openEditModal(<?php echo e($schedule->toJson()); ?>)"
    ...
    <div id="scheduleModal"
        class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 dark:bg-opacity-70 p-4">
        <div class="bg-white dark:bg-slate-900 rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div
                class="border-b border-slate-200 dark:border-slate-700 px-6 py-4 flex justify-between items-center sticky top-0 bg-white dark:bg-slate-900">
            ...
            <form id="scheduleForm" method="POST" action="<?php echo e(route('admin.lms.schedules.store')); ?>"
                class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <span id="classroom_id-error"
                        class="text-sm text-red-600 dark:text-red-400 hidden mt-1 block"></span>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="time" id="end_time" name="end_time" required
                            class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-800 dark:text-white">
                        <span id="end_time-error"
                            class="text-sm text-red-600 dark:text-red-400 hidden mt-1 block"></span>
                    </div>
                </div>

                <div
                    class="border-t border-slate-200 dark:border-slate-700 pt-4 flex gap-3 sticky bottom-0 bg-white dark:bg-slate-900">
                    <button type="button" onclick="closeModal()"
...
<?php endif; ?><?php /**PATH C:\LMSBACKEND\selaju-system\resources\views/admin/lms/schedules/index.blade.php ENDPATH**/ ?>