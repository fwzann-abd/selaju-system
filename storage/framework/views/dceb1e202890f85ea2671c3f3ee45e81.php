...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between">
            ...
            <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 transition-colors duration-200">
                    Lupa password?
                </a>
            <?php endif; ?>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\fwzan\selaju-system\resources\views/auth/login.blade.php ENDPATH**/ ?>